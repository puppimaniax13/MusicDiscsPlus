...
public class mdpSoundEvents {
    ...
    //NCS
    public static final SoundEvent ABOUT_ME = register("about_me");
    ...
    public static final SoundEvent CRADLES = register("cradles");
    public static final SoundEvent DEMONS = register("demons");
    public static final SoundEvent FEARLESS = register("fearless");
    public static final SoundEvent FEARLESS_PT2 = register("fearless_pt2");
    public static final SoundEvent FEEL_GOOD = register("feel_good");
    public static final SoundEvent FIND_YOU = register("find_you");
    public static final SoundEvent GRAVITY = register("gravity");
    public static final SoundEvent HEART_AFIRE = register("heart_afire");
    ...
    public static final SoundEvent ON_AND_ON = register("on_and_on");
    ...
    public static final SoundEvent WALK_AWAY = register("walk_away");
    ...
    //Tik Tok
    public static final SoundEvent AFTER_PARTY = register("after_party");
    public static final SoundEvent BE_HAPPY = register("be_happy");
    public static final SoundEvent BLUEBERRY_FAYGO = register("blueberry_faygo");
    public static final SoundEvent BOSS_BITCH = register("boss_bitch");
    public static final SoundEvent BRING_IT_AROUND = register("bring_it_around");
    public static final SoundEvent BROKE_BITCH = register("broke_bitch");
    public static final SoundEvent COSTA_RICA = register("costa_rica");
    public static final SoundEvent CRYSTAL_DOLPHIN = register("crystal_dolphin");
    public static final SoundEvent DEATH = register("death");
    public static final SoundEvent DEEP_END_FREESTYLE = register("deep_end_freestyle");
    public static final SoundEvent DO_MY_DANCE = register("do_my_dance");
    public static final SoundEvent FAST = register("fast");
    public static final SoundEvent FML = register("fml");
    public static final SoundEvent FURTHER_UP = register("further_up");
    public static final SoundEvent GO_STUPID = register("go_stupid");
    public static final SoundEvent I_WANNA_ROCK = register("i_wanna_rock");
    public static final SoundEvent LEVEL_UP = register("level_up");
    public static final SoundEvent LO_MEIN = register("lo_mein");
    public static final SoundEvent LOSE_CONTROL = register("lose_control");
    public static final SoundEvent MY_TYPE = register("my_type");
    public static final SoundEvent NIKE_TICKS = register("nike_ticks");
    public static final SoundEvent NONSTOP = register("nonstop");
    public static final SoundEvent OUT_WEST = register("out_west");
    public static final SoundEvent PARTY_GIRL = register("party_girl");
    public static final SoundEvent ROCKSTAR = register("rockstar");
    public static final SoundEvent RODEO = register("rodeo");
    public static final SoundEvent ROSCOES = register("roscoes");
    public static final SoundEvent ROSES = register("roses");
    public static final SoundEvent ROXANNE = register("roxanne");
    public static final SoundEvent SAVAGE_TIKTOK = register("savage_tiktok");
    public static final SoundEvent SAY_SO = register("say_so");
    public static final SoundEvent SKETCHERS = register("sketchers");
    public static final SoundEvent SNAKE = register("snake");
    public static final SoundEvent SOMETHING_FOR_YOUR_MIND = register("something_for_your_mind");
    public static final SoundEvent STARDUST = register("stardust");
    public static final SoundEvent STUNNIN = register("stunnin");
    public static final SoundEvent STUPID = register("stupid");
    public static final SoundEvent SUNDAY_BEST = register("sunday_best");
    public static final SoundEvent THE_BOX = register("the_box");
    public static final SoundEvent THEY_CALL_ME_TIAGO = register("they_call_me_tiago");
    public static final SoundEvent TOOSIE_SLIDE = register("toosie_slide");
    public static final SoundEvent WHATS_POPPIN = register("whats_poppin");
    public static final SoundEvent WHERES_MY_JUUL = register("wheres_my_juul");
